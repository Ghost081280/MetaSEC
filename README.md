# MetaSEC is a secure data transfer and storage solution for businesses and organizations. It utilizes a combination of blockchain technology, Amazon Web Services (AWS), Hyperledger Fabric, and Ethereum to ensure confidential and secure data transfers with storage.
