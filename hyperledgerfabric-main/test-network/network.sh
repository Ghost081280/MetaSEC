...
function networkDown() {
  ...
  for dir in ${PWD}/addNewOrg/fabric-ca/*/; do
        FolderName=$(basename $dir);
        docker-compose -f addNewOrg/fabric-ca/${FolderName}/docker/docker-compose-couch.yaml \
        -f addNewOrg/fabric-ca/${FolderName}/docker/docker-compose.yaml \
        -f addNewOrg/fabric-ca/${FolderName}/docker/docker-compose-ca.yaml down --volumes --remove-orphans
  done
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    for dir in ${PWD}/addNewOrg/fabric-ca/*/; do
        FolderName=$(basename $dir);
        docker run --rm -v "$(pwd):/data" busybox sh -c 'cd /data && rm -rf addNewOrg/fabric-ca/${FolderName}/msp addNewOrg/fabric-ca/${FolderName}/tls-cert.pem addNewOrg/fabric-ca/${FolderName}/ca-cert.pem addNewOrg/fabric-ca/${FolderName}/IssuerPublicKey addNewOrg/fabric-ca/${FolderName}/IssuerRevocationPublicKey addNewOrg/fabric-ca/${FolderName}/fabric-ca-server.db'
        rm -r addNewOrg/fabric-ca/${FolderName};
    done
