...
peer lifecycle chaincode approveformyorg  --orderer localhost:7050 --ordererTLSHostnameOverride orderer.o3.fit \
                                          --channelID mychannel  \
                                          --name papercontract  \
                                          -v 0  \
...
peer lifecycle chaincode commit -o localhost:7050 \
                                ...
                                --ordererTLSHostnameOverride orderer.o3.fit \
...
peer chaincode invoke -o localhost:7050  --ordererTLSHostnameOverride orderer.o3.fit \
                                --peerAddresses localhost:7051 --tlsRootCertFiles "${PEER0_ORG1_CA}" \
                                --peerAddresses localhost:9051 --tlsRootCertFiles "${PEER0_ORG2_CA}" \
...
peer chaincode query -o localhost:7050  --ordererTLSHostnameOverride orderer.o3.fit \
                                        --channelID mychannel \
                                        --name papercontract \
