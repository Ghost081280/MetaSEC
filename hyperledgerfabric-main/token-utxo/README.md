...
```
fabric-ca-client enroll -u https://minter:minterpw@localhost:7054 --caname ca-org1 -M "${PWD}/organizations/peerOrganizations/org1.o3.fit/users/minter@org1.o3.fit/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/org1/tls-cert.pem"
```

Run the command below to copy the Node OU configuration file into the minter identity MSP folder.
```
cp "${PWD}/organizations/peerOrganizations/org1.o3.fit/msp/config.yaml" "${PWD}/organizations/peerOrganizations/org1.o3.fit/users/minter@org1.o3.fit/msp/config.yaml"
```
...
```
fabric-ca-client enroll -u https://recipient:recipientpw@localhost:8054 --caname ca-org2 -M "${PWD}/organizations/peerOrganizations/org2.o3.fit/users/recipient@org2.o3.fit/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/org2/tls-cert.pem"
```

Run the command below to copy the Node OU configuration file into the recipient identity MSP folder.
```
cp "${PWD}/organizations/peerOrganizations/org2.o3.fit/msp/config.yaml" "${PWD}/organizations/peerOrganizations/org2.o3.fit/users/recipient@org2.o3.fit/msp/config.yaml"
```
...
export CORE_PEER_MSPCONFIGPATH=${PWD}/organizations/peerOrganizations/org1.o3.fit/users/minter@org1.o3.fit/msp
...
export CORE_PEER_MSPCONFIGPATH=${PWD}/organizations/peerOrganizations/org2.o3.fit/users/recipient@org2.o3.fit/msp
export CORE_PEER_TLS_ROOTCERT_FILE=${PWD}/organizations/peerOrganizations/org2.o3.fit/peers/peer0.org2.o3.fit/tls/ca.crt
...
```
x509::CN=recipient,OU=client,O=Hyperledger,ST=North Carolina,C=US::CN=ca.org2.o3.fit,O=org2.o3.fit,L=Hursley,ST=Hampshire,C=UK
```
