...
createChannel() {
	...
	CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/partya.o3.fit/users/Admin@partya.o3.fit/msp
...
joinChannel () {
	...
	do
		...
		CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/$org.o3.fit/users/Admin@$org.o3.fit/msp
...
checkCommitReadiness() {
	...
	do
		...
		export CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/$org.o3.fit/users/Admin@$org.o3.fit/msp
...
setReferenceRate() {
	...
	CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/rrprovider.o3.fit/users/User1@rrprovider.o3.fit/msp
...
createSwap() {
	CORE_PEER_LOCALMSPID=partya
	CORE_PEER_ADDRESS=irs-partya:7051
	CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/partya.o3.fit/users/User1@partya.o3.fit/msp
	echo "===================== Invoking chaincode ===================== "
...
settlePayment() {
	...
	CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/partyb.o3.fit/users/User1@partyb.o3.fit/msp
	echo "===================== Invoking chaincode ===================== "
