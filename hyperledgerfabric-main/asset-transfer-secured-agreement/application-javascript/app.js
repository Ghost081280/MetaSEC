...
async function initGatewayForOrg1() {
	...
	console.log(`*** Help Logs1:, ${JSON.stringify(ccpOrg1)}`);

	// build an instance of the fabric ca services client based on
	// the information in the network configuration
	const caOrg1Client = buildCAClient(FabricCAServices, ccpOrg1, 'ca.org1.o3.fit');
...
async function initGatewayForOrg2() {
	...
	const caOrg2Client = buildCAClient(FabricCAServices, ccpOrg2, 'ca.org2.o3.fit');
